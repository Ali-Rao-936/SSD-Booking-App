...
import com.ss.delivery.booking.garage.presenter.settings.ProfileActivity

class EditImageChooseSheet constructor(context: ProfileActivity) : BottomSheetDialogFragment() {


    val activity: ProfileActivity = context
    ...
    companion object {
        const val TAG = "EditImageBottomSheet"
    }
